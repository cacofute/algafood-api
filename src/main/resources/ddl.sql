...
create table produto (id bigint not null auto_increment, ativo bit not null, nome varchar(255), preco double precision, restaurante_id bigint, primary key (id)) engine=InnoDB
